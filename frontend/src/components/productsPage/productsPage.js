        ...
        <>
            <div className="mid-container products-page-mid">
                <div className="list-container">
                    ...
                    ) : props.typeOfPage === "women" ? (
                        <h1 className="section-header">Women</h1>
                    ) : props.typeOfPage === "kids" ? (
                        <h1 className="section-header">Kids</h1>
                    ) : null}
                    ...
                    <ul className="full-List">
                        ...
                        <ul className="semi-List">
                            <li
                                className="list-section middle"
                                name="sneakers"
                                onClick={changeProductsType}
                            >
                                Sneakers
                            </li>
                            <li
                            ...
                            <li className="list-section" name="boots" onClick={changeProductsType}>
                                Boots
                            </li>
                            <li className="list-section" name="socks" onClick={changeProductsType}>
                                Socks
                            </li>
                        </ul>
                    </ul>
